...
if __name__ == "__main__":
    ...
    for year in range(2014, 2015):
        ...
        input_tif_directory = current_dir.parent.parent / 'sample data' /'US-WorldPOP' /'raw'
        
        # clipped usa pop dataset
        #output_tif_directory = current_dir.parent.parent / 'data' /'US-WorldPOP-2014-2020'/'clipped'
        output_tif_directory = current_dir.parent.parent / 'sample data' /'US-WorldPOP'/'clipped'
        
        # usa boundary
        #geojson_path = current_dir.parent.parent / 'data' /'US-map'/ 'usa_map.geojson'
        geojson_path = current_dir.parent.parent / 'sample data' /'US-map'/ 'LA_map.geojson' 
        ...
        stations_file =current_dir.parent.parent / 'sample data' /'US-EV-Station'/f'LA_charging_location_{tiff_year}.geojson'
